...
#'
#' @description `vis_obs_density()` visualizes actual and predicted counts 
#' generated by [get_obs_density()].
#'
#' @param actual_data actual data in the form of `hyperframe$column`.
#' @param density_1 im object that represents densities
#' @param density_2 density 2 (if any). By default, `NA`.
#' @param density_3 density 3 (if any). By default, `NA`.
