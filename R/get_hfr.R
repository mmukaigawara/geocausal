...
get_hfr <- function(x, date, coordinates, x.class, x.subtype,
                    y, y.class, y.subtype, window,
                    jitter = TRUE, jitter_amount = 0.0001) {

  # The date column may not be a Date object.
  # Check the class of date column and convert it to Date objects if necessary
