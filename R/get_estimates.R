...
#' @param cf1_med_log_sum_dens sum of log densities of mediators for counterfactual 1 (if `mediation = TRUE`)
#' @param cf2_med_log_sum_dens sum of log densities of mediators for counterfactual 2 (if `mediation = TRUE`)
...
get_estimates <- function(obs_dens,
  ...
  estimates <- get_est(weighted_surf_1 = estimates_1,
