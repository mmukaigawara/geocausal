...
dist_actual_points <- exp(-dist_from_actual_points[[1]]/1000)/
  spatstat.geom::integral(dist_from_actual_points[[1]])
...
```{r}
# Counterfactual 1
counterfactual_mosul_road <- get_cf_dens(base_dens = baseline_density,
                                         expected_number = target_number,
                                         power_dens = power_mosul_road$density,
                                         window = iraq_window,
                                         grayscale = FALSE)
...
```{r}
# Counterfactual 2
counterfactual_mos_bagh <- get_cf_dens(base_dens = baseline_density,
                                       expected_number = target_number,
                                       power_dens = power_mos_bagh$density,
                                       window = iraq_window,
                                       grayscale = FALSE)
...
Finally, save the outputs to prepare for the next vignette.
