...
sim_power_mosul <- simulate_power_density(target_densities = list(dist_from_routes), #This must be a list element
...
sim_power_road <- simulate_power_density(target_densities = list(dist_mosul), #This must be a list element
...
```{r}
sim_counter_road <- simulate_counterfactual_density(expected_number = target_number,
                                                    baseline_density = baseline_density,
