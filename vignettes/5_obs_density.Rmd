...
To do this, we use a function called <tt>predict_obs_density</tt>. This function is basically the same as <tt>get_obs_density</tt> function, except for <tt>ratio</tt> argument to split out training and test samples.
