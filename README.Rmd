...
Several computationally intensive functions (e.g., `smooth_ppp()`, `get_dist_focus()`, `get_dist_line()`) are implemented with the [future](https://cran.r-project.org/package=future) framework and run sequentially by default. To run them in parallel, register a parallel backend before calling them:
...
<div style="text-align: center;">
  <a href="https://github.com/mmukaigawara/geocausal">
    <img src="inst/figure/poster.png" align="center" height="auto" />
  </a>
</div>
